...
insert into wad(id, name, genre, iwad) values ('24f0241c-38a2-4777-aafe-b7f9df60d2b4', 'No End In Sight', 'Classic', 'Doom');

insert into map(id, name, author, enemies, wad_id) values ('f4c55928-97e5-4e03-b6de-d8b720033f80', 'Entrance', 'Skillsaw', 512, 'a15d5780-b37d-11ec-b909-0242ac120002');
